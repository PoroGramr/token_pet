...
final class LanguageSettings: ObservableObject {
    ...
    private static let english: [String: String] = [
        ...
        "새로고침": "Refresh",
        "사용량 제공자": "Usage Source",
        "Codex CLI를 찾을 수 없습니다": "Could not find Codex CLI",
        "Codex App Server를 실행하지 못했습니다": "Could not start Codex App Server",
        "Codex 사용량 조회 시간이 초과되었습니다": "Codex usage request timed out",
        "Codex 사용량 응답을 확인하지 못했습니다": "Could not read the Codex usage response",
        "Codex 사용량을 불러오지 못했습니다": "Could not load Codex usage",
        "자동 새로고침 간격": "Refresh Interval",
        "1분": "1 minute",
        "5분": "5 minutes",
        "10분": "10 minutes",
        "30분": "30 minutes",
        ...
        "기본 캐릭터의 이미지와 이름은 보호됩니다. 퍼센트 위치만 직접 조절할 수 있습니다.": "The default character's images and name are protected. You can adjust only the percentage position.",
